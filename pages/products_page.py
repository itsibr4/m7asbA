# -*- coding: utf-8 -*-
"""
صفحة المنتجات - تصميم احترافي مع دعم عجلة الماوس
"""
...
class ProductDialog(QDialog):
    ...
    def _build_ui(self):
        ...
        self.barcode_input.setFont(QFont("Segoe UI", 12))
        ...
        self.category_input.setFont(QFont("Segoe UI", 12))

        self.product_type_input = QLineEdit(self.product["product_type"] if self.product and self.product.get("product_type") else "")
        self.product_type_input.setPlaceholderText("مثال: إلكترونيات، ملابس...")
        self.product_type_input.setObjectName("dialogInput")
        self.product_type_input.setMinimumHeight(36)
        self.product_type_input.setFont(QFont("Segoe UI", 12))
        ...
        self.year_input.setFont(QFont("Segoe UI", 12))
        ...
        self.purchase_price.setMinimumHeight(32)
        self.purchase_price.setFont(QFont("Segoe UI", 12))
        ...
        self.sale_price.setMinimumHeight(32)
        self.sale_price.setFont(QFont("Segoe UI", 12))
        ...
        self.quantity.setFont(QFont("Segoe UI", 12))
        ...
        self.min_quantity.setMinimumHeight(32)
        self.min_quantity.setFont(QFont("Segoe UI", 12))
...
class ProductsPage(QWidget):
    ...
    def _build_ui(self):
        ...
        self.product_count = QLabel("إجمالي: 0")
        self.product_count.setObjectName("statBadge")
        self.product_count.setFont(QFont("Segoe UI", 11))
        ...
        # Table with wheel scrolling
        self.table = WheelTableWidget(0, 10)
        self.table.setHorizontalHeaderLabels(
            ["المنتج", "الباركود", "التصنيف", "النوع", "السنة", "شراء", "بيع", "الكمية", "تعديل", "حذف"]
        )
        ...
        self.prev_btn.setFont(QFont("Segoe UI", 11))
        ...
        self.page_size_combo.setFont(QFont("Segoe UI", 11))
    ...
    def refresh(self):
        ...
        self.product_count.setText(f"إجمالي: {len(self.all_products)}")
        self.refresh_table_page()
